...
| Company | Paperclip ID | Manifest | Status | Budget cap (monthly) |
|---|---|---|---|---|
| Olympus | `ec35552a-a808-46f3-acbe-4e6dec4969f1` (issuePrefix `OLY`) | [`companies/olympus.md`](companies/olympus.md) | **Active** (created 2026-04-27) | `0` cents = unlimited; cap pending |
| Rios Operator | — | [`companies/rios-operator.md`](companies/rios-operator.md) | Placeholder | — |
| AEGIS | — | [`companies/aegis.md`](companies/aegis.md) | Placeholder | — |
| WearForRun | — | [`companies/wearforrun.md`](companies/wearforrun.md) | Placeholder | — |
| SafePlace | — | [`companies/safeplace.md`](companies/safeplace.md) | Placeholder | — |

Each company manifest defines: charter, budget, agent roster (subset of `roles/`), KPIs, escalation rules, and the source-of-truth product repo path.
...
- [ ] Migrate a real Olympus wave-plan into Paperclip task defs as the first *implementation* task
...
- [ ] Set Olympus monthly budget cap (currently `0` cents = unlimited — review Anthropic console first)
