...
def purpose_from_plan(plan_rel, raw=""):
    ...
    a generated /tmp plan, still yields its header). Machine directives
    (DISPATCH:, Law:, Generated by …) are skipped: the Floor prints this line
    as the reason a run exists.
    """
    candidates = []
    if plan_rel:
