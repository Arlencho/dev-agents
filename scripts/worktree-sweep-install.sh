...
echo ""
echo "The sweep will now run once a day automatically. It does two things:"
echo "  1. merged-PR worktrees and branches of \$OLYMPUS_ROOT (olympus-platform)"
echo "  2. per-seat worktrees and dispatch runtimes under ~/dev older than a day,"
echo "     via make seat-worktree-sweep-apply in \$DEV_AGENTS_ROOT (dev-agents)"
echo "Both default to the checkouts under dev-projects/AI-Orchestration. Override with:"
