...
_FE_NUMERIC_KEYS=" seq exit wave waves seats attempt duration_s elapsed_s succeeded failed total blocked cooldown_minutes next_wave files_edited commands_run tests_run commits_made "
