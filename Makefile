...
test: ## Ground Truth unit tests (launchers, failover, routing, roster, dispatch lock, autoplan fail-closed, vendor-auth)
	...
	@echo ""
	@echo "== dispatch lock (one local dispatch per repo) =="
